...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 24 nov 2022 om 10:14
...
('DoctrineMigrations\\Version20221124084413', '2022-11-24 09:44:18', 59),
('DoctrineMigrations\\Version20221124084901', '2022-11-24 09:49:09', 83),
('DoctrineMigrations\\Version20221124085137', '2022-11-24 09:51:40', 80);
...
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `student_number`, `first_name`, `last_name`) VALUES
(1, 'admin@email.com', '[\"ROLE_ADMIN\"]', '$2y$13$rjYDn5AjdKb.Vz1W.WBFOuZN4vQjsEUDdc06qAMPJ9Ui5E2BDz2CS', 2147483647, 'Koen', 'Green');
...
ALTER TABLE `user_events`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_36D54C779D86650F` (`user_id_id`),
...
ALTER TABLE `user_events`
  ...
  ADD CONSTRAINT `FK_36D54C779D86650F` FOREIGN KEY (`user_id_id`) REFERENCES `user` (`id`);
COMMIT;
